...
export default function GlassButton({ label, to, delay = 0 }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Main diamond sweep — L ➜ R (per your last code), full height, softer brightness */}
      <motion.span
        ...
        style={{
          ...
          filter: 'blur(1.2px)',
          background:
            'linear-gradient(270deg,              rgba(0,0,0,0) 0%,              rgba(176,216,255,0.06) 18%,              rgba(196,228,255,0.14) 30%,              rgba(255,248,236,0.22) 42%,              rgba(231,214,255,0.16) 54%,              rgba(176,216,255,0.08) 68%,              rgba(0,0,0,0) 100%)',
        }}
        animate={{ x: ['-110%', '120%'], opacity: [0.55, 0.75, 0.55] }}
        transition={{ duration: 6.24, repeat: Infinity, ease: 'linear' }}
      />

      {/* Center glint — full height */}
      <motion.span
        className="absolute inset-y-0 left-0 rounded-2xl pointer-events-none mix-blend-screen"
        style={{
          width: '200%',
          filter: 'blur(0.9px)',
          background:
            'linear-gradient(90deg,              rgba(0,0,0,0) 0%,              rgba(190,230,255,0.04) 30%,              rgba(255,255,245,0.12) 50%,              rgba(215,205,255,0.08) 70%,              rgba(0,0,0,0) 100%)',
        }}
