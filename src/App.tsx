...
const i18n: Record<Lang, any> = {
  ...
  en:{ hero:{sub:'Futur543543543435m: depth, soft motion and polymer UI.'}, buttons:['Portfolio','Shop','Traineeeeeeing','Contacts','Sign in'] },
  ...
  return(<div className='relative min-h-screen'>
    ...
    <div className='relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-6'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
        ...
        <div className='sm:col-span-2 flex justify-center'><GlassButton label={copy.buttons[4]} to='/auth' delay={0.2}/></div>
      </div>
...
export default function App(){
  ...
  return(<AnimatePresence mode='wait'><Routes location={location} key={location.pathname}><Route path='/' element={<Home lang={lang}/>}/><Route path='/portfolio' element={<PageWrap><Portfolio/></PageWrap>}/><Route path='/shop' element={<PageWrap><Shop/></PageWrap>}/><Route path='/training' element={<PageWrap><Training/></PageWrap>}/><Route path='/contacts' element={<PageWrap><Contacts/></PageWrap>}/><Route path='/auth' element={<PageWrap><AuthPage/></PageWrap>}/><Route path='/admin' element={<ProtectedRoute requireAdmin><PageWrap><AdminPage/></PageWrap></ProtectedRoute>}/></Routes></AnimatePresence>)
}
