...
function Home(){return (<div className='relative min-h-screen bg-black bg-stars'><div className='relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-6'><img src='/iz-logo.svg' className='w-44 md:w-56 mb-4 opacity-90' alt='logo'/><p className='max-w-2xl text-white/70 mb-8'>Future-ready beauty system: depth, soft motion and polymer UI.</p><div className='grid grid-cols-1 sm:grid-cols-2 gap-4'><GlassButton label='Portfolio' to='/'/><GlassButton label='Shop' to='/' delay={0.05}/><GlassButton label='Training' to='/' delay={0.1}/><GlassButton label='Contacts' to='/' delay={0.15}/></div><div className='mt-10 text-sm text-white/60'>izhairtrend.shop · support@izhairtrend.shop</div></div></div>)}
